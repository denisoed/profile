<template>
  <section
    class="portfolio section-padding wow fadeIn pb-0"
    data-scroll-index="3"
  >
    <div class="container">
...
const PROJECTS = [
  {
    ...
    tag: "Github",
    description:
      "Experimental AI agent company dashboard for orchestrating workspace-scoped agents, tasks, roles, Telegram bots, cron jobs, and pipeline-style automation.",
